...
function fnScore(){
	...
	function tab(){
		...
		function start(ev){
			...
			bind(doc,'touchmove', prevent);
			bind(doc,'WebkitTouchmove',prevent);
		}
		...
		function end(ev){
			...
			translate();
			auto();
			doc.removeEventListener('touchmove', prevent,false);
			doc.removeEventListener('WebkitTouchmove', prevent,false);
		}
