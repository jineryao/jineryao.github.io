...
function fnScore(){
	...
	function tab(){
		...
		function start(ev){
			...
			bind(doc,'touchstart', prevent);
			bind(doc,'WebkitTouchstart',prevent);
		}
		...
		function end(ev){
			...
			translate();
			auto();
			doc.removeEventListener('touchstart', prevent,false);
			doc.removeEventListener('WebkitTouchstart', prevent,false);
		}
